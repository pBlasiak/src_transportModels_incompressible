...
{
    defineTypeNameAndDebug(HeliumFineOnebyf, 0);
	...
	const Foam::label
	Foam::HeliumModels::HeliumFineOnebyf::largeIndex_(6672);

	const Foam::scalar
	Foam::HeliumModels::HeliumFineOnebyf::dTFineOnebyf_(0.0001);
...
//void Foam::HeliumModels::HeliumFineOnebyf::fineOnebyf()
//{
//	forAll(T_, celli)
//	{
...
Foam::HeliumModels::HeliumFineOnebyf::HeliumFineOnebyf
(
    const word& name,
...
:
    Helium(name, HeliumProperties, U, phi)
{}


// * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * * //

void Foam::HeliumModels::HeliumFineOnebyf::correct()
{
